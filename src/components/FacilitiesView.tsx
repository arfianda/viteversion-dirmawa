...
export default function FacilitiesView({ setCurrentTab }: FacilitiesViewProps) {
  // Modal states
  const [emergencyModalOpen, setEmergencyModalOpen] = React.useState<boolean>(false);
  const [insuranceModalOpen, setInsuranceModalOpen] = React.useState<boolean>(false);
  const [bookingModalOpen, setBookingModalOpen] = React.useState<boolean>(false);
  ...
  return (
    <div className="space-y-12 animate-fade-in">
      ...
      <section className="relative rounded-3xl overflow-hidden py-16 md:py-24 px-6 md:px-12 bg-slate-900 text-white shadow-xl">
        ...
        <div className="relative z-10 max-w-2xl space-y-6">
          ...
          <p className="text-sm sm:text-base text-slate-300 leading-relaxed max-w-xl">
            Komitmen kami untuk mendukung kesejahteraan, kesehatan, dan pertumbuhan profesional setiap mahasiswa Universitas Pelita Bangsa melalui ekosistem layanan yang inklusif.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-white p-8 rounded-2xl shadow-sm border border-slate-200/80 flex flex-col sm:flex-row gap-8 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            <div className="sm:w-2/5 flex flex-col justify-between">
              <div>
                ...
                <h2 className="font-sans font-black text-2xl text-[#001e40] tracking-tight">UKK</h2>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-wide mb-6">Unit Kesehatan Kampus</p>
              </div>
            ...
            <div className="sm:w-3/5 border-t sm:border-t-0 sm:border-l border-slate-200/80 pt-6 sm:pt-0 sm:pl-8 flex flex-col justify-between">
              <div>
                <p className="text-sm text-slate-500 leading-relaxed mb-6">
                  Fasilitas kesehatan primer yang menyediakan pertolongan pertama, konsultasi medis umum, dan obat-obatan dasar bagi seluruh civitas akademika. Kami memastikan respon cepat untuk keadaan darurat medis di area kampus.
                </p>
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    <li key={idx} className="flex items-start gap-2.5 text-xs font-semibold text-slate-700">
                      <CheckCircle2 size={16} className="text-[#001e40] flex-shrink-0 mt-0.5" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
          ...
          <div className="lg:col-span-5 bg-[#001e40] p-8 rounded-2xl text-white relative overflow-hidden group shadow-md hover:shadow-lg transition-all duration-300 flex flex-col justify-between min-h-[350px]">
            <div className="relative z-10">
              ...
              <h2 className="font-sans font-black text-2xl tracking-tight mb-2">Asuransi Mahasiswa</h2>
              <p className="text-xs text-slate-300 leading-relaxed mb-6 opacity-90">
                Perlindungan kesehatan dan kecelakaan selama masa studi aktif di Universitas Pelita Bangsa.
              </p>
            </div>

            {/* Card Mockup */}
            <div className="relative z-10 bg-gradient-to-br from-white to-slate-50 p-5 rounded-2xl text-slate-800 shadow-xl border border-white/20 transform group-hover:scale-[1.02] transition-transform duration-300">
              <div className="flex justify-between items-start mb-6">
                <div className="font-sans font-black text-[10px] text-[#001e40] tracking-wider">
                  KARTU PESERTA ASURANSI
                </div>
                <CreditCard size={18} className="text-[#feb234]" />
              </div>
              <div className="space-y-3">
                <div className="border-b border-slate-200/80 pb-1.5">
                  <div className="text-[9px] uppercase font-bold text-slate-400">Nama Mahasiswa</div>
                  <div className="text-xs font-bold text-[#001e40]">JOHANES SURYA KUSUMA</div>
                </div>
                <div className="flex gap-4">
                  <div className="border-b border-slate-200/80 pb-1.5 flex-1">
                    <div className="text-[9px] uppercase font-bold text-slate-400">NIM</div>
                    <div className="text-xs font-bold text-[#001e40]">312210456</div>
                  </div>
                  <div className="border-b border-slate-200/80 pb-1.5 flex-1">
            ...
            <button 
              ...
              className="mt-6 flex items-center gap-2 text-xs font-bold text-[#feb234] hover:text-[#ffddb2] hover:gap-3 transition-all duration-300 bg-transparent border-none outline-none text-left w-fit relative z-10 cursor-pointer"
            >
              <span>Unduh E-Card &amp; Panduan Klaim</span>
              <ArrowRight size={14} />
            </button>
            ...
            <div className="flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  Kami percaya bahwa kesehatan mental adalah fondasi dari kesuksesan akademik. Tim psikolog kami siap mendengarkan dan mendampingi Anda melewati tantangan akademik maupun personal dengan kerahasiaan penuh.
                </p>
              </div>
      ...
      {/* Contact CTA Section */}
      <section id="contact-section" className="py-12 bg-slate-100/60 rounded-3xl text-center border border-slate-200/50">
        ...
        <p className="text-xs sm:text-sm text-slate-500 mb-6 max-w-md mx-auto leading-relaxed px-4">
          Direktorat Kemahasiswaan siap membantu Anda mendapatkan informasi dan layanan terbaik di kampus.
        </p>
      ...
      {emergencyModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={() => setEmergencyModalOpen(false)}></div>
          <div className="relative bg-white w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl border border-slate-100 z-10 animate-fade-in">
            <div className="p-6 bg-[#001e40] text-white flex justify-between items-center">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="font-sans font-black text-lg">Prosedur Darurat Medis Kampus</h3>
              </div>
              <button onClick={() => setEmergencyModalOpen(false)} className="text-white/80 hover:text-white">
                <X size={20} />
              </button>
            </div>
            <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              <div className="flex gap-3.5 p-3.5 bg-red-50 border border-red-100 rounded-xl">
                ...
                <div className="text-xs text-red-900 leading-normal">
                  <strong>PENTING:</strong> Untuk kejadian kritis/mengancam nyawa, segera hubungi Unit Kesehatan Kampus via ekstensi internal <strong>119</strong> atau hubungi ambulans luar.
                </div>
              </div>
              <div className="space-y-4">
                <h4 className="text-xs font-bold text-[#001e40] uppercase tracking-wide">Alur Penanganan Medis:</h4>
                <ol className="space-y-3.5">
                  <li className="flex gap-3">
                    <span className="w-5 h-5 bg-[#001e40] text-white rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 mt-0.5">1</span>
                    <div className="text-xs text-slate-600 leading-normal">
                      <strong>Pelaporan Awal:</strong> Laporkan lokasi kejadian, nama korban, dan kondisi umum ke nomor UKK (Ext 104) atau dosen/staf terdekat.
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-5 h-5 bg-[#001e40] text-white rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 mt-0.5">2</span>
                    <div className="text-xs text-slate-600 leading-normal">
                      <strong>Tindakan Pertama (P3K):</strong> Jika aman dan Anda terlatih, berikan pertolongan pertama dasar menggunakan kotak P3K yang tersedia di lobi lift tiap gedung.
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-5 h-5 bg-[#001e40] text-white rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 mt-0.5">3</span>
                    <div className="text-xs text-slate-600 leading-normal">
                      <strong>Evakuasi ke UKK:</strong> Tim medis UKK akan menuju lokasi atau korban dievakuasi langsung menggunakan tandu ke ruang rawat sementara UKK di Gedung C Lantai 1.
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="w-5 h-5 bg-[#001e40] text-white rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 mt-0.5">4</span>
                    <div className="text-xs text-slate-600 leading-normal">
                      <strong>Rujukan Rumah Sakit:</strong> Bila dibutuhkan penanganan lanjutan, UKK akan merujuk mahasiswa ke Rumah Sakit Mitra terdekat menggunakan ambulans kampus.
                    </div>
                  </li>
                </ol>
              </div>
      ...
      {/* 2. Insurance Claims & Download Modal */}
      {insuranceModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={() => setInsuranceModalOpen(false)}></div>
          <div className="relative bg-white w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl border border-slate-100 z-10 animate-fade-in">
            <div className="p-6 bg-[#001e40] text-white flex justify-between items-center">
              <div className="flex items-center gap-2.5">
                <Shield className="text-[#feb234]" size={22} />
                <h3 className="font-sans font-black text-lg">Panduan Klaim Asuransi Mahasiswa</h3>
              </div>
              <button onClick={() => setInsuranceModalOpen(false)} className="text-white/80 hover:text-white">
                <X size={20} />
              </button>
            </div>
            <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              <p className="text-xs text-slate-500 leading-relaxed">
                Setiap mahasiswa aktif Universitas Pelita Bangsa secara otomatis tercover oleh asuransi kecelakaan diri selama masa studi. Berikut adalah berkas dan langkah pengajuan klaim:
              </p>
              <div className="space-y-4">
                <div>
                  <h4 className="text-xs font-bold text-[#001e40] uppercase tracking-wide mb-2">Dokumen yang Dibutuhkan:</h4>
                  <ul className="space-y-2 text-xs text-slate-650">
                    <li className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 bg-[#feb234] rounded-full"></div>
                      <span>Formulir Klaim Asuransi (diunduh di bawah)</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 bg-[#feb234] rounded-full"></div>
                      <span>KTM / Kartu E-Card Asuransi Aktif</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 bg-[#feb234] rounded-full"></div>
                      <span>Surat Keterangan Dokter &amp; Rincian Biaya Rumah Sakit</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="w-1.5 h-1.5 bg-[#feb234] rounded-full"></div>
                      <span>Kuitansi Pembayaran Rumah Sakit Asli</span>
                    </li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-xs font-bold text-[#001e40] uppercase tracking-wide mb-2">Alur Pengajuan Klaim:</h4>
                  <ol className="space-y-2.5 text-xs text-slate-650 list-decimal pl-4">
                    <li>Laporkan kejadian kecelakaan ke Bagian Layanan Kemahasiswaan maksimal 3x24 jam.</li>
                    <li>Lengkapi dokumen klaim yang dibutuhkan.</li>
                    <li>Serahkan seluruh berkas ke loket Kemahasiswaan di Gedung B Lantai 2.</li>
                    <li>Dana klaim akan ditransfer ke rekening mahasiswa bersangkutan dalam kurun waktu 14 hari kerja setelah berkas dinyatakan lengkap oleh pihak asuransi.</li>
                  </ol>
                </div>
              </div>
            </div>
            <div className="p-4 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row gap-2.5 sm:justify-between items-center">
              <div className="text-[10px] text-slate-400 font-mono text-center sm:text-left">
                Format file: PDF (Klaim_Guide_UPB.pdf)
              </div>
              <div className="flex gap-2">
                <button 
                  onClick={() => setInsuranceModalOpen(false)}
                  className="px-4 py-2 bg-slate-200 hover:bg-slate-350 transition-colors text-[#001e40] font-sans font-bold text-xs rounded-lg"
                >
                  Batal
                </button>
                <button 
                  onClick={() => {
                    alert('Simulasi unduhan: Panduan_Klaim_Asuransi.pdf dan E_Card_Asuransi.png berhasil disimpan!');
                    setInsuranceModalOpen(false);
                  }}
                  className="px-4 py-2 bg-[#feb234] hover:bg-[#feb234]/90 transition-all text-[#001e40] font-sans font-bold text-xs rounded-lg shadow-sm"
                >
                  Unduh Berkas
                </button>
              </div>
      ...
      {bookingModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-slate-950/60 backdrop-blur-sm" onClick={resetBookingForm}></div>
          <div className="relative bg-white w-full max-w-lg rounded-2xl overflow-hidden shadow-2xl border border-slate-100 z-10 animate-fade-in">
            <div className="p-6 bg-[#001e40] text-white flex justify-between items-center">
              <div className="flex items-center gap-2.5">
                <Brain className="text-[#feb234]" size={22} />
                <h3 className="font-sans font-black text-lg">Booking Konseling Mahasiswa</h3>
              </div>
              <button onClick={resetBookingForm} className="text-white/80 hover:text-white">
                <X size={20} />
              </button>
            </div>
            ...
            {!bookingSuccess ? (
              <form onSubmit={handleBookingSubmit} className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                <p className="text-xs text-slate-500 leading-relaxed mb-4">
                  Silakan tentukan jadwal kosong Anda. Privasi dan identitas Anda dijamin sepenuhnya rahasia oleh kode etik psikolog.
                </p>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-black uppercase text-slate-500 mb-1">Nama Mahasiswa</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-[10px] font-black uppercase text-slate-500 mb-1">NIM</label>
                    <input 
                      type="text" 
                ...
                <div>
                  <label className="block text-[10px] font-black uppercase text-slate-500 mb-1">Email Mahasiswa</label>
                  <input 
                    type="email" 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-black uppercase text-slate-700 mb-1">Pilih Tanggal *</label>
                    <input 
                      type="date" 
                      required
                  ...
                  <div>
                    <label className="block text-[10px] font-black uppercase text-slate-700 mb-1">Pilih Jam *</label>
                    <select 
                      required
                ...
                <div>
                  <label className="block text-[10px] font-black uppercase text-slate-700 mb-1">Keluhan / Catatan Tambahan (Opsional)</label>
                  <textarea 
                    rows={3}
              ...
              <div className="p-10 flex flex-col items-center text-center space-y-4">
                ...
                <h4 className="font-sans font-black text-xl text-[#001e40]">Pengajuan Berhasil Dikirim!</h4>
                <div className="text-xs text-slate-500 leading-relaxed max-w-sm">
                  Permohonan sesi konseling untuk tanggal <strong>{bookingForm.date}</strong> pukul <strong>{bookingForm.time} WIB</strong> telah didaftarkan. Tim psikolog kami akan menghubungi Anda melalui email <strong>{bookingForm.email}</strong> untuk konfirmasi lanjutan.
                </div>
                <button 
                  onClick={resetBookingForm}
